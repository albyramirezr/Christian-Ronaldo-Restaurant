...
-- Tiempo de generación: 02-12-2019 a las 02:24:06
...
CREATE TABLE IF NOT EXISTS `tdetalle` (
  `Num_Detalle` varchar(10) CHARACTER SET utf8 NOT NULL,
  `Cantidad` int(4) NOT NULL,
  `Precio_Final` int(8) NOT NULL,
  `Num_Factura` int(10) NOT NULL,
  `Cod_Producto` varchar(20) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `templeados` (
  `ID_Empleado` varchar(9) CHARACTER SET utf8 NOT NULL,
  `Nombre_E` varchar(40) CHARACTER SET utf8 NOT NULL,
  `Apellido_E` varchar(40) CHARACTER SET utf8 NOT NULL,
  `Correo_E` varchar(30) CHARACTER SET utf8 NOT NULL,
  `Telefono_E` varchar(15) CHARACTER SET utf8 NOT NULL,
  `Direccion_E` varchar(60) CHARACTER SET utf8 NOT NULL,
  `Cargo` varchar(30) CHARACTER SET utf8 NOT NULL,
  `Fecha_Ingreso` date NOT NULL,
  `Departamento` varchar(20) CHARACTER SET utf8 NOT NULL,
  `Numero_de_Cuenta` varchar(16) CHARACTER SET utf8 NOT NULL,
  `Salario_Base` varchar(9) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tfactura` (
  ...
  `Modo_Pago` varchar(10) CHARACTER SET utf8 NOT NULL,
  `ID_Cliente` varchar(9) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tingredientes` (
  `Cod_Ingrediente` varchar(20) CHARACTER SET utf8 NOT NULL,
  `Nombre_In` varchar(25) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tinventario` (
  `Cod_Inventario` varchar(20) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tpedidos` (
  `Nro_Pedido` varchar(8) CHARACTER SET utf8 NOT NULL,
  `Cod_Producto` varchar(20) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE IF NOT EXISTS `treceta` (
  `Cod_Receta` varchar(20) CHARACTER SET utf8 NOT NULL,
  `Comentario` varchar(300) CHARACTER SET utf8 NOT NULL,
